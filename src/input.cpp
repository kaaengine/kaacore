...
bool
Event::is_keyboard_event() const
{
    return (
        this->sdl_event.type == SDL_KEYUP or
        this->sdl_event.type == SDL_KEYDOWN);
}

bool
Event::is_mouse_event() const
{
    return (
        this->sdl_event.type == SDL_MOUSEBUTTONUP or
        this->sdl_event.type == SDL_MOUSEBUTTONDOWN);
}

bool
Event::is_pressing(Keycode kc) const
{
    return (
...
bool
Event::is_pressing(Mousecode mc) const
{
    return (
...
bool
Event::is_releasing(Keycode kc) const
{
    return (
...
bool
Event::is_releasing(Mousecode mc) const
{
    return (
...
glm::dvec2
Event::get_mouse_position() const
{
...
bool
InputManager::is_pressed(Keycode kc) const
{
...
bool
InputManager::is_pressed(Mousecode mc) const
{
    return (
        SDL_GetMouseState(NULL, NULL) & SDL_BUTTON(static_cast<uint8_t>(mc)));
}

bool
InputManager::is_released(Keycode kc) const
{
    auto scancode = SDL_GetScancodeFromKey(static_cast<SDL_Keycode>(kc));
...
bool
InputManager::is_released(Mousecode mc) const
{
    return not(
        SDL_GetMouseState(NULL, NULL) & SDL_BUTTON(static_cast<uint8_t>(mc)));
}
...
glm::dvec2
InputManager::get_mouse_position() const
{
    int pos_x, pos_y;
