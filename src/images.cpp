...
bgfx::TextureHandle
make_texture(
    const bimg::ImageContainer* const image_container, const uint64_t flags)
{
...
Image::Image(
    bgfx::TextureHandle texture_handle, bimg::ImageContainer* image_container)
{
...
Resource<Image>
Image::load(const char* path, uint64_t flags)
{
