...
struct FontResourcesRegistryKey {
    ...
    FontResourcesRegistryKey(const std::string& path, const UnicodeView additional_codepoints)
    ...
    bool operator==(const FontResourcesRegistryKey& other) const
    {
        return this->path == other.path &&
               this->additional_codepoints.view() == other.additional_codepoints.view();
    }
};
...
class FontData : public Resource {
  public:
    ...
    ~FontData();
    static ResourceReference<FontData> load(const std::string& path, const UnicodeView additional_codepoints);
...
class Font {
  public:
    ...
    static Font load(const std::string& font_filepath, const UnicodeView additional_codepoints);
